...
@section('leftmenuone')
  <li class="nav-item text-center p-3">
    <a class="text-white text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#editmeetingModal">Изменить заседание</a>
  </li>
@endsection
              ...
              <h5 class="card-title text-truncate">{{$data -> name}}</h5>
                ...
                <div class="mt-3 row d-flex justify-content-center">
                  <div class="col-4 mb-3">
                    <a class="btn btn-light w-100" href="#" data-bs-toggle="modal" data-bs-target="#editmeetingModal">
                    <i class="bi-three-dots"></i></a>
                  </div>
                  <div class="col-2 mb-3">
                    <a class="btn btn-light w-100" href="{{ route ('MeetingDelete', $data->id) }}">
